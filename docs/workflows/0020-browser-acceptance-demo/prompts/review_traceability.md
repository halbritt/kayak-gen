Read `docs/workflows/0020-browser-acceptance-demo/SOURCES.md`, especially RFC
0008, the web verification notes, the web app, Dockerfile, CLI serve command,
and tests.

Produce `striatum/0020-browser-acceptance-demo/traceability/REVIEW_TRACEABILITY.md`
with:
