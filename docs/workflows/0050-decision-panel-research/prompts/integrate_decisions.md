Integrate workflow 0050 research and panel votes.

Read all research artifacts and all panel vote artifacts under
`striatum/0050-decision-panel-research/`. For each of the eight decisions,
apply strict majority rule:
...
- `striatum/0050-decision-panel-research/integration/`.
...
full desktop parity, or real high-angle stability unless an implementation
workflow later proves it.
