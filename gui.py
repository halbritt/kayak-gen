...
class KayakGUI:
    ...
    def _build_sliders(self):
        ...
        for i, (key, label, vmin, vmax) in enumerate(self.SLIDERS):
            ...
            ax = self.fig.add_axes([0.13, y, 0.17, 0.025])
    ...
    def _build_button(self):
        ax_btn = self.fig.add_axes([0.04, 0.205, 0.11, 0.045])
        ...
        ax_rst = self.fig.add_axes([0.17, 0.205, 0.11, 0.045])
        self.btn_reset = widgets.Button(ax_rst, "Reset", color="0.75", hovercolor="0.85")
        self.btn_reset.on_clicked(self._on_reset)

        ax_3d = self.fig.add_axes([0.04, 0.255, 0.24, 0.045])
