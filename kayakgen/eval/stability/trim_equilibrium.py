"""Bounded fixed-body upright trim solver and section-geometry helpers.

The trim solver handles load cases with explicit longitudinal components by
solving a 2-D bisection over trim angle (outer) and midship draft (inner) on
station-area polygons clipped to a trimmed waterline.
"""
